...
public class MainView {
  ...
  private CheckBox cropBetweenParticipantsField;
  private CheckBox cropVerticalEnabledField;
  ...
  private ComboBox<HeaderFade> headerFadeField;
  ...
  private Parent templateEditor() {
    ...
    cropBetweenParticipantsField = new CheckBox("Also remove empty gaps between participants (may shift the time scale)");
    cropVerticalEnabledField = new CheckBox("Trim empty space above/below the athletes");
    enhanceEnabledField = new CheckBox("Auto-enhance image (automatic, based on the photo)");
    canvasBackgroundColorField = new TextField();
    headerEnabledField = new CheckBox("Show top header");
    headerHeightField = slider(5, 30, 10);
    headerFadeField = new ComboBox<>(FXCollections.observableArrayList(HeaderFade.values()));
    ...
    grid.add(cropVerticalEnabledField, 1, row++, 2, 1);
    grid.add(cropBetweenParticipantsField, 1, row++, 2, 1);
    ...
    grid.add(new Label("Header fade"), 0, row);
    grid.add(headerFadeField, 1, row++, 2, 1);
  ...
  private void saveTemplate() {
    ...
    boolean cropBetweenParticipants = cropBetweenParticipantsField.isSelected();
    boolean cropVerticalEnabled = cropVerticalEnabledField.isSelected();
    ...
    HeaderFade headerFade = headerFadeField.getValue();
    ...
    CompletableFuture
        .supplyAsync(() -> {
          try {
            ...
            template.setCropBetweenParticipants(cropBetweenParticipants);
            template.setCropVerticalEnabled(cropVerticalEnabled);
            ...
            template.setHeaderFade(valueOrDefault(headerFade, HeaderFade.LEFT_TO_RIGHT));
  ...
  private void setTemplateFields(BrandingTemplate template) {
    ...
    cropBetweenParticipantsField.setSelected(template.isCropBetweenParticipants());
    cropVerticalEnabledField.setSelected(template.isCropVerticalEnabled());
    ...
    headerFadeField.setValue(valueOrDefault(template.getHeaderFade(), HeaderFade.LEFT_TO_RIGHT));
  ...
  private BrandingTemplate templateFromFields() {
    ...
    template.setCropBetweenParticipants(cropBetweenParticipantsField.isSelected());
    template.setCropVerticalEnabled(cropVerticalEnabledField.isSelected());
    ...
    template.setHeaderFade(valueOrDefault(headerFadeField.getValue(), HeaderFade.LEFT_TO_RIGHT));
